...
session.set_use_clarifai(enabled=True, secret='ckzkAbWotlXDjV8ED54JQl6fJfqkQMoPHnJ4UUW4', proj_id='gGQzG7lrLcdQ1uWh37iq1taNPLz5wJOtJ2IDYN-Y')
#                                        ^
...
session.clarifai_check_img_for(['dog', 'cat', 'cute', 'horse'], comment=True, comments=['Sweet!', 'So great!'])
